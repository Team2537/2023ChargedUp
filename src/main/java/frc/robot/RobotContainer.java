...
import frc.robot.kotlin.TestClass;
...
public class RobotContainer {
    ...
    // DECLARE KOTLIN OBJECTS HERE:
    private final TestClass m_testClass = new TestClass();
    ...
    private void configureButtonBindings() {
        ...
        // moveForwardTrigger.whileTrue(new SetChassisStateCommand(m_swerveSubsystem, ()
        // -> 0.1, () -> 0.0, null));
        moveRightTrigger.whileTrue(new SetChassisStateCommand(m_swerveSubsystem, () -> 0.0, () -> -0.1, null));
        // moveBackTrigger.whileTrue(new SetChassisStateCommand(m_swerveSubsystem, () ->
        // -0.1, () -> 0.0, null));
    ...
    public Command placeAndDriveCommand() {
        PathPlannerTrajectory trajPath = PathPlanner.loadPath("Backup",
                new PathConstraints(3.0,
                        3.5)); // meters per second //seems to work better when constraint acceleration is
                               // higher than path planner acceleration

        // PathPlannerTrajectory.transformTrajectoryForAlliance(trajPath,
    ...
    public Command redGetTwoPieceCmd() {
        ...
        return new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        new PathCommand(m_swerveSubsystem, trajReversePath), // ends parallel deadline group when path
                                                                             // command ends
                        new SequentialCommandGroup(
                                new WaitUntilDesiredHeadingCommand(m_swerveSubsystem, Rotation2d.fromDegrees(180.0)),
                                new FixedAngleCommand(m_armPivotSubsystem, 15.66),
    ...
    // new ParallelCommandGroup(
    // new SequentialCommandGroup(
    // new WaitUntilDesiredHeadingCommand(m_swerveSubsystem,
